...
async function runTest(name, testFunction) {
  ...
  // テスト終了後にアラームをクリア
  await new Promise((resolve) => chrome.alarms.clearAll(resolve));
  console.log("🧹 テスト終了後のアラームをクリアしました。");
...
async function clearAllAlarmsAndNotifications() {
  console.log("🧹 全アラームと通知設定をクリアしています...");

  // すべてのアラームをクリア
  await new Promise((resolve) => chrome.alarms.clearAll(resolve));
  console.log("✅ アラームをクリアしました。");
  ...
  console.log("✅ 超過勤務アラームをクリアしました。");

  console.log("🧹 すべてのアラームと通知設定がクリアされました。");
}

// 使用例: clearAllAlarmsAndNotifications();
// ======================ここまでをコピペ=======================
