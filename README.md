...
- 🏁 **退勤済み検出**
- 🔔 **通知音**（退勤時刻・休憩終了時にアラーム音で通知、オン/オフ切り替え可能）
- 👆 **通知クリックで freee ページに移動**（通知をクリックすると freee のタブを開く）
- 📌 **重要な通知は消えない**（退勤・休憩終了の通知はクリックするまで表示され続ける）
...
- **「通知音を鳴らす」** にチェックを入れると、退勤時刻や休憩終了時にアラーム音が鳴ります
- 通知の種類によって異なる音が鳴ります（警告音・成功音・チャイム音）
- 設定完了時や休憩開始時など、確認用の通知では音は鳴りません

#### 👆 通知クリック

- 通知をクリックすると、freee の勤怠ページに移動します
- 既に freee のタブが開いている場合は、そのタブがアクティブになります
